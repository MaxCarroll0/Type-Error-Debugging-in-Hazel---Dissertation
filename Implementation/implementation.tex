...
I implement \textit{three} different search methods, implementing the non-determinism signature specified in \cref{sec:ResolvingNondeterminism}.
...
However, as \code{f} is mapped to the entire bag \code{b}, it is difficult to maintain laziness in OCaml. \textbf{TODO - explain how}

\subsubsection{Iterative Deepening Depth First Search}

\subsubsection{Interleaved Streams}
??? think about removing fairness, and treating this as a search procedure.
