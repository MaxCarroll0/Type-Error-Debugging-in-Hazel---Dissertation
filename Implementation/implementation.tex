...
The Hazel architecture demonstrates in \cref{fig:Architecture} with green files/directories added, orange files modified \textit{significantly}, and blue files modified \textit{insignificantly}\footnote{However, still needing to know how they work.} or unmodified. 97 files were added/edited, not all can fit, so anything omitted is considered insignificant to understanding this project.
