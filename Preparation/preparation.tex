...
In order to enumerate try multiple solutions, \textit{multiple continuations} must be used. JSOO\footnote{Javascript of OCaml. A dependency of Hazel.} does not (at time of writing) allow these.
